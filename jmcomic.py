...
class Jmcomic():
    ...
    def like_check(self):
        ...
        "sec-ch-ua-full-version": "\"127.0.2651.86\"",
        "sec-ch-ua-full-version-list": "\"Not)A;Brand\";v=\"99.0.0.0\", \"Microsoft Edge\";v=\"127.0.2651.86\", \"Chromium\";v=\"127.0.6533.89\"",
        "sec-ch-ua-mobile": "?0",
        "sec-ch-ua-model": "\"\"",
        "sec-ch-ua-platform": "\"Windows\"",
        ...
        data = {
            "album_id": "313827", # ComicID
            "vote": "likes"
        }
        while True:
            response = Unicode(requests.post(url, headers=headers, cookies=self.cookies, data=data).text)
            if DEBUG: print(response)
            msg = json.loads(response)['msg']
            if msg == '評價成功 !': print('評價成功 + 5Exp') ; break
